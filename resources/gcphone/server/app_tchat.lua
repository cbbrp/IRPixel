...
RegisterServerEvent('gcPhone:tchat_channelirpixel')
AddEventHandler('gcPhone:tchat_channelirpixel', function(channel)
    local sourcePlayer = tonumber(source)
    TchatGetMessageChannel(channel, function (messages)
        TriggerClientEvent('gcPhone:tchat_channelirpixel', sourcePlayer, channel, messages)
    end)
end)
