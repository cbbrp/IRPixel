-- Settings
local color = { r = 230, g = 168, b = 236, alpha = 255 } -- Color of the text 
...
AddEventHandler('3dme:triggerDisplay', function(text, source, chat)
    local offset = 1 + (nbrDisplaying*0.14)
    Display(GetPlayerFromServerId(source), text, offset, chat)
end)

function Display(mePlayer, text, offset, chat)
