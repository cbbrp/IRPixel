...
function EnableSocietyMoneyHUDElement()
  	local societyMoneyHUDElementTpl = '<div style="bottom:8px; right:16px;t"><img src="' .. base64MoneyIcon .. '" style="width:20px; height:20px; vertical-align:middle;">&nbsp;{{money}}</div>'
...
AddEventHandler('esx_society:openBosirpixelsMenu', function(society, close, options)
