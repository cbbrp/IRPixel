...
function restartPrices()
	DrugPrices.marijuana = math.random(210, 270)
	DrugPrices.crack = math.random(4920, 6000)
	DrugPrices.cocaine = math.random(1900, 2200)
	DrugPrices.heroine = math.random(8100, 9000)
	DrugPrices.meth = math.random(2000, 2300)
