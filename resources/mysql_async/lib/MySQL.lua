...
function MySQL.Sync.execute(query, params)
    ...
    exports['mysql_async']:mysql_execute(query, safeParameters(params), function (result)
        res = result
        finishedQuery = true
    end)
...
function MySQL.Sync.fetchAll(query, params)
    ...
    local res = {}
    local finishedQuery = false
    exports['mysql_async']:mysql_fetch_all(query, safeParameters(params), function (result)
        res = result
        finishedQuery = true
    end)
    repeat Citizen.Wait(0) until finishedQuery == true
...
function MySQL.Sync.fetchScalar(query, params)
    ...
    local res = ''
    local finishedQuery = false
    exports['mysql_async']:mysql_fetch_scalar(query, safeParameters(params), function (result)
        res = result
        finishedQuery = true
    end)
    repeat Citizen.Wait(0) until finishedQuery == true
...
function MySQL.Sync.insert(query, params)
    ...
    local res = 0
    local finishedQuery = false
    exports['mysql_async']:mysql_insert(query, safeParameters(params), function (result)
        res = result
        finishedQuery = true
    end)
    repeat Citizen.Wait(0) until finishedQuery == true
...
function MySQL.Sync.transaction(querys, params)
    local res = 0
    local finishedQuery = false
    exports['mysql_async']:mysql_transaction(query, params, function (result)
        res = result
        finishedQuery = true
    end)
    repeat Citizen.Wait(0) until finishedQuery == true
...
function MySQL.Async.execute(query, params, func)
    ...
    exports['mysql_async']:mysql_execute(query, safeParameters(params), func)
end
...
function MySQL.Async.fetchAll(query, params, func)
    ...
    exports['mysql_async']:mysql_fetch_all(query, safeParameters(params), func)
end
...
function MySQL.Async.fetchScalar(query, params, func)
    ...
    exports['mysql_async']:mysql_fetch_scalar(query, safeParameters(params), func)
end
...
function MySQL.Async.insert(query, params, func)
    ...
    exports['mysql_async']:mysql_insert(query, safeParameters(params), func)
end
...
function MySQL.Async.transaction(querys, params, func)
    return exports['mysql_async']:mysql_transaction(querys, params, func)
end

function MySQL.ready (callback)
    Citizen.CreateThread(function ()
        -- add some more error handling
        while GetResourceState('mysql_async') ~= 'started' do
            Citizen.Wait(0)
        end
        while not exports['mysql_async']:is_ready() do
            Citizen.Wait(0)
        end
        callback()
    end)
