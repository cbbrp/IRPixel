...
function setNuiActive(boolean = true) {
  if (boolean !== isNuiActive) {
    if (boolean) {
      window.emitNet('mysql_async:request-data');
    }
    isNuiActive = boolean;
...
window.onNet('mysql_async:update-resource-data', (resourceData) => {
...
window.onNet('mysql_async:update-time-data', (timeData) => {
  let timeArray = [];
...
window.onNet('mysql_async:update-slow-queries', (slowQueryData) => {
