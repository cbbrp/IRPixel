...
function spectate(target)
	...
	ESX.TriggerServerCallback('esx:getPlayerData', function(player)
		...
		TriggerEvent('esx_idoverhead:modifydistance', 100)
...
function resetNormalCamera()
	...
	TriggerEvent('esx_idoverhead:modifydistance', 10)
end
...
function OpenAdminActionMenu(player)
    ...
    ESX.TriggerServerCallback('esx_spectate:getOtherPlayerData', function(data)
      ...
      local elements = {
		...
		{label = 'Gang: '.. data.gang, value = nil},
...
Citizen.CreateThread(function()
  	...
  	while true do
		...
		if InSpectatorMode then
			...
			SetEntityCoords(playerPed,  coords.x, coords.y, coords.z + 4)
