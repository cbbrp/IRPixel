local Components = {
  ...
  {label = _U('face_1'),                name = 'face_1',        value = 0,    min = 0,  zoomOffset = 0.6,   camOffset = 0.65}, --
...
function ApplySkin(skin, clothes)
  ...
  SetPedHeadBlendData     (playerPed, Character['face_1'], Character['face_2'], 0, Character['skin'], Character['skin'], Character['skin'], Character['face_3'] * 0.1, Character['face_3'] * 0.1, 0, true)
  ...
  if Character['sex'] == 1 then
    if Character['hair_1'] == 0 then SetPedComponentVariation(GetPlayerPed(-1), 2, 39 + 0, Character['hair_1'], 2)
    elseif Character['hair_1'] == 1 then SetPedComponentVariation(GetPlayerPed(-1), 2, 39 + Character['hair_1'], 0, 2)
    elseif Character['hair_1'] == 2 then 
      SetPedComponentVariation(GetPlayerPed(-1), 2, 39 + Character['hair_1'], 0, 2)
      if hats == 0 then
        SetPedPropIndex(GetPlayerPed(-1), 0, 5, 0, 2)
      end
    elseif Character['hair_1'] == 3 then SetPedComponentVariation(GetPlayerPed(-1), 2, 39 + Character['hair_1'], 0, 2)
    elseif Character['hair_1'] == 38 then SetPedComponentVariation(GetPlayerPed(-1), 2, 2, 0, 2)
    elseif Character['hair_1'] == 39 then SetPedComponentVariation(GetPlayerPed(-1), 2, 1, 0, 2)
    elseif Character['hair_1'] == 40 then SetPedComponentVariation(GetPlayerPed(-1), 2, 0, 0, 2)
    elseif Character['hair_1'] >= 24 then SetPedComponentVariation(GetPlayerPed(-1), 2, Character['hair_1'] + 1, 0, 2)
    elseif Character['hair_1'] > 3 then SetPedComponentVariation(GetPlayerPed(-1), 2, Character['hair_1'], 0, 2) end
  else
		SetPedComponentVariation	(GetPlayerPed(-1), 2, Character['hair_1'], 0, 2)
  end
