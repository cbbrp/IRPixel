...
AddEventHandler('addDonationCar', function(newOwner, plate)
	...
	TriggerServerEvent('esx_vehicleshop:setVehicleOwnedirpixelPlayerId', newOwner, vehicleProps, vehtype)
end)
...
AddEventHandler('esx:spawnVehicle', function(model)
	ESX.TriggerServerCallback('esx_aduty:checkAdmin', function(isAdmin)
        ...
        if isAdmin then
			...
			TriggerServerEvent('esx_ban:BanMySelf', "Tried to spawn vehicle with admin shit events!", "Cheat Lua executor")
        end
