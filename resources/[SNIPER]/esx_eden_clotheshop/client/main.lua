													...
													function(data3, menu3)
														...
														if data3.current.value == 'buyforgang' then
															...
															for i=1, #foundGang do
																table.insert(elements, {label = foundGang[i]})
															end
        ...
        ESX.TriggerServerCallback('esx_eden_clotheshop:getPlayerDressing', function(dressing)
          ...
          ESX.UI.Menu.Open(
            ...
            function(data, menu)
                ...
                ESX.UI.Menu.Open(
                'default', GetCurrentResourceName(), 'confirm_chage',
                {
                    title = "Tayid taviz lebas",
                    align = 'top-right',
                    elements = {
                        {label = "Aya az avaz kardan lebas khod motmaen hastid?", value = 'question'},
