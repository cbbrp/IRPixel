      ...
      getPhoneNumber(tonumber(k), function (n)
        if n ~= nil then
          ...
          if phone ~= nil and phone.count > 0 then doeshavephone = true else doeshavephone = false end
            ...
            TriggerEvent('gcPhone:_internalAddMessageirpixel', number, n, 'From #' .. alert.numero  .. ' : ' .. alert.message, 0, function (smsMess)
            TriggerClientEvent("gcPhone:receiveMessage", tonumber(k), smsMess, doeshavephone)
            TriggerEvent('gcPhone:_internalAddMessageirpixel', number, n, 'GPS: ' .. alert.coords.x .. ', ' .. alert.coords.y, 0, function (smsMess)
            TriggerClientEvent("gcPhone:receiveMessage", tonumber(k), smsMess, false)
          end)
          end)
        end
      end)
