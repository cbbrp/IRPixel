...
Config.Vehicles = {
	{model = 'smallboat', label = 'Ghayegh Mahigiri', price = 100000},
	{model = 'seashark', label = 'Seashark (Random Color)', price = 1000000},
	{model = 'seashark3', label = 'Seashark (Dark Blue)', price = 1500000},
	{model = 'suntrap', label = 'Suntrap', price = 2300000},
	{model = 'jetmax', label = 'Jetmax', price = 5800000},
	{model = 'tropic2', label = 'Tropic', price = 4300000},
	{model = 'dinghy2', label = 'Dinghy 2seater', price = 435000},
	{model = 'dinghy4', label = 'Dinghy 4seater', price = 540000},
	{model = 'speeder', label = 'Speeder', price = 6800000},
	{model = 'squalo', label = 'Squalo (Random Color)', price = 5100000},
	{model = 'toro', label = 'Toro', price = 9000000},
	{model = 'sr650fly', label = 'SeaRay', price = 18000000},
	{model = 'dodo', label = 'Dodo', price = 25000000}
}